...
export function CardProduct() {
    ...
    return (
        <div>
            <div className="w-[250px] lg:w-[230px] relative">
                ...
                <div className="py-3 grid gap-1">
                    ...
                    <div className="flex items-baseline gap-2">
                        <h1 className="font-[600] text-[19px]">Rp 599.000</h1>
                        <h1 className="text-[14px] line-through text-[#a7a7a7]">Rp 399.000</h1>
                    </div>
                    <p className="text-[13px] text-[#a7a7a7]">Sold 15</p>
                </div>
                <Button onClick={() => setIsFilled(!isFilled)} className="bg-transparent border-1 border-[#CCC] rounded-full w-full">{isFilled ? <IsFilled /> : <Filled />}Wishlist</Button>
                <div>
                </div>
            </div>
        </div>
