...
export default function Forum() {
    return (
        <div>
            <section className='w-full h-screen container mx-auto px-10 py-45 flex flex-col gap-10'>
                <div className='flex flex-col gap-3'>
                    <div className='flex items-center gap-4'>
                        <KeyboardIcon className='text-5xl' />
                ...
                <div className='flex items-start gap-5'>
                    <div className='w-full'>
                        <h1 className='text-[20px] font-[600]'>Diskusi Terbaru</h1>
                    </div>
                    <div className=''>
