                        ...
                        <div className="w-full flex items-start gap-10">
                            <div className="flex flex-col gap-5">
                                ...
                                <div className='w-full flex items-center gap-5'>
                                    <Button className='w-full bg-shoppe rounded-full text-white font-[500] py-6'>Shoppe</Button>
                                    <Button className='w-full bg-tokopedia rounded-full text-white font-[500] py-6'>Tokopedia</Button>
                                </div>
                            </div>
